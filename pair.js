...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'joygloria390276@gmail.com', // Your Mega A/c Email Here
            password: 'joygloria1' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'Dante-XMD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029Vb4sHtX6hENwn07deE1a) 


🚀 _Thanks for choosing Dante-Xmd — Let the automation begin!_ ✨`;
